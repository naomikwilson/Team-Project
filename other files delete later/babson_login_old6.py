...
def login(driver, url, username, password):
    ...
    #     time.sleep(1)
    # except:
    #     print("[!] Login failed. Incorrect username used.")
    #     raise ValueError("Incorrect username used.")
    # try:
    #     driver.find_element(By.ID, "i0118").send_keys(password)
    #     driver.find_element(By.ID, "i0118").send_keys(Keys.ENTER)
    #     driver_wait(driver, 1)
    ...
    # except:
    #     print("[!] Login failed. Incorrect password used.")
    #     raise ValueError("Incorrect password used.")
    ...
    try:
        ...
        raise ValueError("[!] Login failed. Incorrect username used.")
